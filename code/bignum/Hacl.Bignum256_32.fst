...
let bn_to_bytes_be b res = Hacl.Bignum.Convert.mk_bn_to_bytes_be n_bytes b res

let bn_to_bytes_le b res = Hacl.Bignum.Convert.mk_bn_to_bytes_le n_bytes b res
